...
namespace Klevu\FrontendMetadata\Test\Integration\Setup\Patch\Data;

use Klevu\FrontendMetadata\Constants;
use Klevu\FrontendMetadata\Setup\Patch\Data\MigrateLegacyConfigurationSettings;
...
class MigrateLegacyConfigurationSettingsTest extends TestCase
{
     ...
     */
    public function testApply_MigrateMetadataEnabled_EnabledGlobal(): void
    {
        ...
        $this->configWriter->save(
            path: MigrateLegacyConfigurationSettings::XML_PATH_LEGACY_METADATA_ENABLED,
            value: '1',
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateMetadataEnabled_DisabledGlobal(): void
    {
        $this->deleteExistingKlevuConfig();
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateMetadataEnabled_EnabledWebsite(): void
    {
        $this->deleteExistingKlevuConfig();
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateMetadataEnabled_DisabledWebsite(): void
    {
        $this->deleteExistingKlevuConfig();
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateMetadataEnabled_EnabledStore(): void
    {
        $this->deleteExistingKlevuConfig();
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateMetadataEnabled_DisabledStore(): void
    {
        $this->deleteExistingKlevuConfig();
